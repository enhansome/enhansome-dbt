...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,452 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 214 | 🐛 227 | 🌐 JavaScript | 📅 2026-09-11 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,134 | 🐛 1,033 | 🌐 TypeScript | 📅 2026-09-11 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,956 | 🐛 19 | 🌐 Go | 📅 2026-09-11 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,406 | 🐛 13 | 🌐 HTML | 📅 2026-09-10 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,869 | 🐛 320 | 🌐 Python | 📅 2026-09-11 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 811 | 🐛 293 | 🌐 TypeScript | 📅 2026-09-11 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 39 | 🌐 Python | 📅 2026-09-11 - This tool formats your dbt SQL code so you don't have to.
...
* [sqllens](https://github.com/NiclasOlofsson/sqllens) ⭐ 3 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-11 - TypeScript SQL parser and static analyzer: type inference, schema diagnostics, and column-level lineage. Reads Jinja-templated SQL (dbt models) natively, without rendering.
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 93 | 🌐 Python | 📅 2026-09-11 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 20 | 🌐 Go | 📅 2026-09-11 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 5 | 🌐 Python | 📅 2026-09-11 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 214 | 🐛 227 | 🌐 JavaScript | 📅 2026-09-11 - Revamped and ported hub of main discussions for the community.
