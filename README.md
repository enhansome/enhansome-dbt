...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,293 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 212 | 🐛 212 | 🌐 JavaScript | 📅 2026-09-06 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,119 | 🐛 1,052 | 🌐 TypeScript | 📅 2026-09-06 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,947 | 🐛 23 | 🌐 Go | 📅 2026-09-05 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 959 | 🐛 71 | 🌐 Python | 📅 2026-09-06 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 700 | 🐛 41 | 🌐 Python | 📅 2026-09-06 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 602 | 🐛 39 | 🌐 Python | 📅 2026-09-04 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,405 | 🐛 24 | 🌐 HTML | 📅 2026-09-03 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,866 | 🐛 331 | 🌐 Python | 📅 2026-09-06 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 806 | 🐛 268 | 🌐 TypeScript | 📅 2026-09-05 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
* [Pre-commit hooks](https://github.com/dbt-checkpoint/dbt-checkpoint) ⭐ 766 | 🐛 66 | 🌐 Python | 📅 2026-08-17 - Pre-commit hooks for checking data integity before schema change commit.
...
* [vscode-dbt-power-user](https://github.com/innoverio/vscode-dbt-power-user) ⭐ 584 | 🐛 162 | 🌐 JavaScript | 📅 2026-09-04 - VSCode extension to give more clarity on model dependencies.
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 38 | 🌐 Python | 📅 2026-09-05 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-loom](https://github.com/nicholasyager/dbt-loom) ⭐ 221 | 🐛 24 | 🌐 Python | 📅 2026-09-06 - A dbt-core plugin to weave together multi-project dbt-core deployments.
...
* [dbt-llm-tools](https://github.com/pragunbhutani/dbt-llm-tools) ⭐ 179 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - RAG based LLM chatbot for dbt projects.
* [dbtpal](https://github.com/PedramNavid/dbtpal) ⭐ 138 | 🐛 10 | 🌐 Lua | 📅 2025-06-19 - A Neovim plugin for dbt model editing.
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 131 | 🐛 7 | 🌐 Python | 📅 2026-09-03 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-ui](https://github.com/data-diving/dbt-ui) ⭐ 125 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-01 - A modern web-based user interface for dbt-core projects
...
* [dlin](https://github.com/eitsupi/dlin) ⭐ 14 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - Gives coding agents instant dbt lineage: no dbt compile, no Python, no grep. Fast model-level lineage CLI parsing SQL files directly (or a `manifest.json`), with experimental column-level lineage too.
...
* [dbt-column-lineage](https://github.com/Oisix/dbt-column-lineage) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26 - Tool to visualize the column level lineage of dbt models.
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 113 | 🌐 Python | 📅 2026-09-06 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-codegen](https://github.com/dbt-labs/dbt-codegen) ⭐ 672 | 🐛 24 | 🌐 Makefile | 📅 2026-07-28 - Macros that generate dbt code, and log it to the command line.
* [dbt-metabase](https://github.com/gouline/dbt-metabase) ⭐ 612 | 🐛 1 | 🌐 Python | 📅 2026-09-02 - Model synchronization from dbt to Metabase.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 206 | 🐛 13 | 🌐 PLSQL | 📅 2026-08-28 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 17 | 🌐 Go | 📅 2026-09-04 - IAC in dbt Cloud via Terraform.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 212 | 🐛 212 | 🌐 JavaScript | 📅 2026-09-06 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 495 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
