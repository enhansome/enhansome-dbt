...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,732 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 217 | 🐛 222 | 🌐 JavaScript | 📅 2026-09-22 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,152 | 🐛 1,121 | 🌐 TypeScript | 📅 2026-09-22 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,971 | 🐛 21 | 🌐 Go | 📅 2026-09-22 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 961 | 🐛 79 | 🌐 Python | 📅 2026-09-22 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 722 | 🐛 32 | 🌐 Python | 📅 2026-09-22 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 610 | 🐛 51 | 🌐 Python | 📅 2026-09-22 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,412 | 🐛 13 | 🌐 HTML | 📅 2026-09-22 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 15 | 🌐 Python | 📅 2026-09-22 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,888 | 🐛 346 | 🌐 Python | 📅 2026-09-22 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 813 | 🐛 297 | 🌐 TypeScript | 📅 2026-09-22 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [ERD Studio](https://github.com/liam-machine/erd-studio) ⭐ 145 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - VS Code extension that puts a visual ERD designer inside your dbt repo. Two-stage (logical/physical) canvas, drift detection against `manifest.json`, auto-generated `selectors.yml`, and AI-readable semantic models (YAML/JSON) with a built-in harness for Claude, Copilot, Gemini, and Codex.
* [dbtpal](https://github.com/PedramNavid/dbtpal) ⭐ 138 | 🐛 10 | 🌐 Lua | 📅 2025-06-19 - A Neovim plugin for dbt model editing.
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 133 | 🐛 6 | 🌐 Python | 📅 2026-09-22 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-Workbench](https://github.com/rezer-bleede/dbt-Workbench) ⭐ 72 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - An open UI for dbt providing model browsing, lineage visualization, run orchestration, documentation, environment management — without vendor lock-in. Designed for local, on‑prem, and air‑gapped deployments.
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 125 | 🌐 Python | 📅 2026-09-22 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-artifacts](https://github.com/brooklyn-data/dbt_artifacts) ⭐ 403 | 🐛 89 | 🌐 Shell | 📅 2026-09-22 - This package builds a mart of tables from dbt artifacts loaded into a table.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 208 | 🐛 15 | 🌐 PLSQL | 📅 2026-09-22 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 19 | 🌐 Go | 📅 2026-09-22 - IAC in dbt Cloud via Terraform.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 217 | 🐛 222 | 🌐 JavaScript | 📅 2026-09-22 - Revamped and ported hub of main discussions for the community.
