...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,719 | 🐛 8 | 📅 2026-08-07 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 44,713 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-10 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 209 | 🐛 203 | 🌐 JavaScript | 📅 2026-08-18 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,056 | 🐛 1,232 | 🌐 TypeScript | 📅 2026-08-18 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,846 | 🐛 17 | 🌐 Go | 📅 2026-08-18 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 946 | 🐛 69 | 🌐 Python | 📅 2026-08-15 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 671 | 🐛 41 | 🌐 Python | 📅 2026-08-18 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 597 | 🐛 36 | 🌐 Python | 📅 2026-08-18 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,392 | 🐛 25 | 🌐 HTML | 📅 2026-08-18 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
* [dq-tools](https://github.com/infinitelambda/dq-tools) ⭐ 56 | 🐛 0 | 🌐 PLpgSQL | 📅 2026-08-18 - Make simple storing test results and visualisation of these in a BI dashboard leveraging 6 Data Quality KPIs.
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 10 | 🌐 Python | 📅 2026-08-18 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,855 | 🐛 323 | 🌐 Python | 📅 2026-08-18 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 792 | 🐛 226 | 🌐 TypeScript | 📅 2026-08-18 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 543 | 🐛 38 | 🌐 Python | 📅 2026-08-18 - This tool formats your dbt SQL code so you don't have to.
...
* [dbterd](https://github.com/datnguye/dbterd) ⭐ 345 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - CLI to generate DBML file from dbt manifest.json.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 126 | 🐛 10 | 🌐 Python | 📅 2026-08-18 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt\_audit\_helper](https://github.com/dbt-labs/dbt-audit-helper/) ⭐ 421 | 🐛 11 | 📅 2026-05-19 - Macros for data audits that compare columns values and schemas between tables.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 64 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 209 | 🐛 203 | 🌐 JavaScript | 📅 2026-08-18 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 473 | 🐛 51 | 🌐 Python | 📅 2026-08-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
