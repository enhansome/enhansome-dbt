...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,726 | 🐛 1 | 📅 2026-09-05 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,422 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 213 | 🐛 223 | 🌐 JavaScript | 📅 2026-09-10 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,130 | 🐛 1,020 | 🌐 TypeScript | 📅 2026-09-10 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,954 | 🐛 18 | 🌐 Go | 📅 2026-09-10 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 959 | 🐛 75 | 🌐 Python | 📅 2026-09-10 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 709 | 🐛 42 | 🌐 Python | 📅 2026-09-10 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 603 | 🐛 46 | 🌐 Python | 📅 2026-09-10 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,406 | 🐛 12 | 🌐 HTML | 📅 2026-09-10 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,866 | 🐛 320 | 🌐 Python | 📅 2026-09-10 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 810 | 🐛 292 | 🌐 TypeScript | 📅 2026-09-10 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [vscode-dbt-power-user](https://github.com/innoverio/vscode-dbt-power-user) ⭐ 585 | 🐛 156 | 🌐 JavaScript | 📅 2026-09-09 - VSCode extension to give more clarity on model dependencies.
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 38 | 🌐 Python | 📅 2026-09-10 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-loom](https://github.com/nicholasyager/dbt-loom) ⭐ 223 | 🐛 26 | 🌐 Python | 📅 2026-09-06 - A dbt-core plugin to weave together multi-project dbt-core deployments.
...
* [dlin](https://github.com/eitsupi/dlin) ⭐ 15 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - Gives coding agents instant dbt lineage: no dbt compile, no Python, no grep. Fast model-level lineage CLI parsing SQL files directly (or a `manifest.json`), with experimental column-level lineage too.
...
* [dbt-column-lineage](https://github.com/Oisix/dbt-column-lineage) ⭐ 1 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - Tool to visualize the column level lineage of dbt models.
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 82 | 🌐 Python | 📅 2026-09-10 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-codegen](https://github.com/dbt-labs/dbt-codegen) ⭐ 675 | 🐛 25 | 🌐 Makefile | 📅 2026-09-10 - Macros that generate dbt code, and log it to the command line.
...
* [dbt-external-tables](https://github.com/dbt-labs/dbt-external-tables) ⭐ 383 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Macros to stage your external sources.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 207 | 🐛 13 | 🌐 PLSQL | 📅 2026-09-10 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [dbt-fabric](https://github.com/microsoft/dbt-fabric) ⭐ 148 | 🐛 44 | 🌐 Python | 📅 2026-08-26 - A dbt adapter for working with Microsoft Fabric Data Warehouses.
* [dbt-meta-testing](https://github.com/tnightengale/dbt-meta-testing) ⭐ 132 | 🐛 10 | 🌐 SQL | 📅 2026-04-16 - Yet another coverage testing.
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 19 | 🌐 Go | 📅 2026-09-10 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 5 | 🌐 Python | 📅 2026-09-10 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 213 | 🐛 223 | 🌐 JavaScript | 📅 2026-09-10 - Revamped and ported hub of main discussions for the community.
