...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,222 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 211 | 🐛 212 | 🌐 JavaScript | 📅 2026-09-03 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,119 | 🐛 1,044 | 🌐 TypeScript | 📅 2026-09-03 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,939 | 🐛 26 | 🌐 Go | 📅 2026-09-03 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 959 | 🐛 68 | 🌐 Python | 📅 2026-09-02 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 699 | 🐛 42 | 🌐 Python | 📅 2026-09-03 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 603 | 🐛 40 | 🌐 Python | 📅 2026-09-03 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,405 | 🐛 26 | 🌐 HTML | 📅 2026-09-03 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 68 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-09-03 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,865 | 🐛 334 | 🌐 Python | 📅 2026-09-03 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 804 | 🐛 267 | 🌐 TypeScript | 📅 2026-09-03 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [vscode-dbt-power-user](https://github.com/innoverio/vscode-dbt-power-user) ⭐ 585 | 🐛 161 | 🌐 JavaScript | 📅 2026-08-31 - VSCode extension to give more clarity on model dependencies.
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 548 | 🐛 38 | 🌐 Python | 📅 2026-08-31 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 130 | 🐛 7 | 🌐 Python | 📅 2026-09-03 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-doctor](https://github.com/joachimhodana/dbt-doctor) ⭐ 54 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - CLI health check and linter for dbt projects (SQL, YAML, Jinja): 190+ custom rules, optional SQLFluff, 0–100 score, GitHub Actions CI, and coding-agent skills.
...
* [dbt-external-tables](https://github.com/dbt-labs/dbt-external-tables) ⭐ 382 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-07-24 - Macros to stage your external sources.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 21 | 🌐 Go | 📅 2026-09-03 - IAC in dbt Cloud via Terraform.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 211 | 🐛 212 | 🌐 JavaScript | 📅 2026-09-03 - Revamped and ported hub of main discussions for the community.
