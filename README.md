...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,722 | 🐛 1 | 📅 2026-08-25 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,035 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-08-25 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 210 | 🐛 207 | 🌐 JavaScript | 📅 2026-08-27 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,096 | 🐛 1,030 | 🌐 TypeScript | 📅 2026-08-28 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,885 | 🐛 16 | 🌐 Go | 📅 2026-08-27 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 946 | 🐛 67 | 🌐 Python | 📅 2026-08-27 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 690 | 🐛 40 | 🌐 Python | 📅 2026-08-27 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 599 | 🐛 39 | 🌐 Python | 📅 2026-08-25 - MCP tools to interact with dbt.
...
* [DataKitchen Open Source Data Observability](https://github.com/DataKitchen/data-observability-installer) ⭐ 141 | 🐛 6 | 🌐 Python | 📅 2026-08-27 - Data breaks. Servers break. dbt and other tools break. Observability and alerting across and down your data estate. Save time with simple, fast data quality test generation and execution.
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 68 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 10 | 🌐 Python | 📅 2026-08-26 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,862 | 🐛 346 | 🌐 Python | 📅 2026-08-26 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 801 | 🐛 258 | 🌐 TypeScript | 📅 2026-08-28 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 38 | 🌐 Python | 📅 2026-08-24 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 128 | 🐛 6 | 🌐 Python | 📅 2026-08-25 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 115 | 🐛 7 | 🌐 Python | 📅 2026-08-27 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
...
* [dbtective](https://github.com/feliblo/dbtective) ⭐ 44 | 🐛 2 | 🌐 Rust | 📅 2026-08-17 Rust-powered 'detective'/linter for dbt project/metadata best practices
...
* [dbt-codegen](https://github.com/dbt-labs/dbt-codegen) ⭐ 671 | 🐛 24 | 🌐 Makefile | 📅 2026-07-28 - Macros that generate dbt code, and log it to the command line.
* [dbt-metabase](https://github.com/gouline/dbt-metabase) ⭐ 610 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - Model synchronization from dbt to Metabase.
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 574 | 🐛 22 | 🌐 Shell | 📅 2026-08-25 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 202 | 🐛 15 | 🌐 PLSQL | 📅 2026-08-25 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 210 | 🐛 207 | 🌐 JavaScript | 📅 2026-08-27 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 484 | 🐛 52 | 🌐 Python | 📅 2026-08-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
