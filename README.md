...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,542 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 215 | 🐛 233 | 🌐 JavaScript | 📅 2026-09-14 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,136 | 🐛 1,026 | 🌐 TypeScript | 📅 2026-09-14 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,962 | 🐛 22 | 🌐 Go | 📅 2026-09-14 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 960 | 🐛 77 | 🌐 Python | 📅 2026-09-14 - Add multi-language support (Python) to your dbt project.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,408 | 🐛 11 | 🌐 HTML | 📅 2026-09-14 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,872 | 🐛 329 | 🌐 Python | 📅 2026-09-13 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 811 | 🐛 299 | 🌐 TypeScript | 📅 2026-09-14 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 132 | 🐛 9 | 🌐 Python | 📅 2026-09-09 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-doctor](https://github.com/joachimhodana/dbt-doctor) ⭐ 61 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - CLI health check and linter for dbt projects (SQL, YAML, Jinja): 190+ custom rules, optional SQLFluff, 0–100 score, GitHub Actions CI, and coding-agent skills.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 20 | 🌐 Go | 📅 2026-09-14 - IAC in dbt Cloud via Terraform.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 215 | 🐛 233 | 🌐 JavaScript | 📅 2026-09-14 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 501 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
