...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 44,901 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 210 | 🐛 211 | 🌐 JavaScript | 📅 2026-08-25 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,075 | 🐛 1,202 | 🌐 TypeScript | 📅 2026-08-25 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,860 | 🐛 18 | 🌐 Go | 📅 2026-08-21 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 946 | 🐛 68 | 🌐 Python | 📅 2026-08-24 - Add multi-language support (Python) to your dbt project.
...
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 598 | 🐛 39 | 🌐 Python | 📅 2026-08-25 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,397 | 🐛 25 | 🌐 HTML | 📅 2026-08-24 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,861 | 🐛 337 | 🌐 Python | 📅 2026-08-22 - SQL linter that supports dbt and Jinja templating.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 210 | 🐛 211 | 🌐 JavaScript | 📅 2026-08-25 - Revamped and ported hub of main discussions for the community.
