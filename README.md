...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,405 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-09 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 213 | 🐛 218 | 🌐 JavaScript | 📅 2026-09-09 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,126 | 🐛 1,046 | 🌐 TypeScript | 📅 2026-09-09 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,952 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 959 | 🐛 72 | 🌐 Python | 📅 2026-09-09 - Add multi-language support (Python) to your dbt project.
...
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 603 | 🐛 42 | 🌐 Python | 📅 2026-09-09 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,406 | 🐛 12 | 🌐 HTML | 📅 2026-09-09 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,866 | 🐛 321 | 🌐 Python | 📅 2026-09-09 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 809 | 🐛 289 | 🌐 TypeScript | 📅 2026-09-09 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 132 | 🐛 7 | 🌐 Python | 📅 2026-09-09 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-column-lineage](https://github.com/Oisix/dbt-column-lineage) ⭐ 1 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-07 - Tool to visualize the column level lineage of dbt models.
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 93 | 🌐 Python | 📅 2026-09-09 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 576 | 🐛 23 | 🌐 Shell | 📅 2026-09-02 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 213 | 🐛 218 | 🌐 JavaScript | 📅 2026-09-09 - Revamped and ported hub of main discussions for the community.
