...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 44,794 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 209 | 🐛 203 | 🌐 JavaScript | 📅 2026-08-21 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,068 | 🐛 1,191 | 🌐 TypeScript | 📅 2026-08-21 - Open source Looker alternative with deep dbt integration.
...
* [fal](https://github.com/fal-ai/fal) ⭐ 946 | 🐛 69 | 🌐 Python | 📅 2026-08-21 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 680 | 🐛 39 | 🌐 Python | 📅 2026-08-21 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,396 | 🐛 26 | 🌐 HTML | 📅 2026-08-21 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,860 | 🐛 336 | 🌐 Python | 📅 2026-08-18 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 793 | 🐛 232 | 🌐 TypeScript | 📅 2026-08-21 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 126 | 🐛 6 | 🌐 Python | 📅 2026-08-21 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 64 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 209 | 🐛 203 | 🌐 JavaScript | 📅 2026-08-21 - Revamped and ported hub of main discussions for the community.
