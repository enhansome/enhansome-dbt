...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,721 | 🐛 1 | 📅 2026-08-25 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,062 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-08-25 - Data engineering course on cutting edge tools including dbt.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,102 | 🐛 1,025 | 🌐 TypeScript | 📅 2026-08-28 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,909 | 🐛 32 | 🌐 Go | 📅 2026-08-28 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 947 | 🐛 67 | 🌐 Python | 📅 2026-08-29 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 693 | 🐛 40 | 🌐 Python | 📅 2026-08-27 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,400 | 🐛 24 | 🌐 HTML | 📅 2026-08-27 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,863 | 🐛 339 | 🌐 Python | 📅 2026-08-28 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 802 | 🐛 262 | 🌐 TypeScript | 📅 2026-08-29 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 116 | 🐛 7 | 🌐 Python | 📅 2026-08-27 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
...
* [dlin](https://github.com/eitsupi/dlin) ⭐ 14 | 🐛 2 | 🌐 Rust | 📅 2026-08-28 - Gives coding agents instant dbt lineage: no dbt compile, no Python, no grep. Fast model-level lineage CLI parsing SQL files directly (or a `manifest.json`), with experimental column-level lineage too.
...
* [dbt\_constraints](https://github.com/Snowflake-Labs/dbt_constraints) ⭐ 176 | 🐛 12 | 🌐 SQL | 📅 2026-05-28 - Generate database constraints based on the tests in a dbt project.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 65 | 🐛 6 | 🌐 Python | 📅 2026-08-27 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
