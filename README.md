...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,628 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,143 | 🐛 1,107 | 🌐 TypeScript | 📅 2026-09-18 - Open source Looker alternative with deep dbt integration.
...
* [fal](https://github.com/fal-ai/fal) ⭐ 960 | 🐛 83 | 🌐 Python | 📅 2026-09-18 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 718 | 🐛 32 | 🌐 Python | 📅 2026-09-17 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 607 | 🐛 47 | 🌐 Python | 📅 2026-09-17 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,410 | 🐛 11 | 🌐 HTML | 📅 2026-09-17 - A dbt package that provides data anomaly detection as dbt tests.
...
* [dbt-beyond-the-basics](https://github.com/pgoslatara/dbt-beyond-the-basics) ⭐ 107 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Showcase of advanced options when running CI for dbt.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,880 | 🐛 323 | 🌐 Python | 📅 2026-09-18 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 813 | 🐛 290 | 🌐 TypeScript | 📅 2026-09-18 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
* [Pre-commit hooks](https://github.com/dbt-checkpoint/dbt-checkpoint) ⭐ 767 | 🐛 69 | 🌐 Python | 📅 2026-08-17 - Pre-commit hooks for checking data integity before schema change commit.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 132 | 🐛 9 | 🌐 Python | 📅 2026-09-17 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 117 | 🐛 12 | 🌐 Python | 📅 2026-09-18 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
* [fzf-dbt](https://github.com/Infused-Insight/fzf-dbt) ⭐ 73 | 🐛 2 | 🌐 Shell | 📅 2023-07-26 - Search dbt models interactively from terminal.
* [dbt-Workbench](https://github.com/rezer-bleede/dbt-Workbench) ⭐ 72 | 🐛 0 | 🌐 Python | 📅 2026-05-30 - An open UI for dbt providing model browsing, lineage visualization, run orchestration, documentation, environment management — without vendor lock-in. Designed for local, on‑prem, and air‑gapped deployments.
...
* [ERD Studio](https://github.com/liam-machine/erd-studio) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-15 - VS Code extension that puts a visual ERD designer inside your dbt repo. Two-stage (logical/physical) canvas, drift detection against `manifest.json`, auto-generated `selectors.yml`, and AI-readable semantic models (YAML/JSON) with a built-in harness for Claude, Copilot, Gemini, and Codex.
...
* [sqllens](https://github.com/NiclasOlofsson/sqllens) ⭐ 3 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-14 - TypeScript SQL parser and static analyzer: type inference, schema diagnostics, and column-level lineage. Reads Jinja-templated SQL (dbt models) natively, without rendering.
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 131 | 🌐 Python | 📅 2026-09-18 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 577 | 🐛 24 | 🌐 Shell | 📅 2026-09-02 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 3 | 🌐 Python | 📅 2026-09-18 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 504 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
