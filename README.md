...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,069 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-08-29 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 210 | 🐛 204 | 🌐 JavaScript | 📅 2026-08-28 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,103 | 🐛 1,025 | 🌐 TypeScript | 📅 2026-08-29 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,919 | 🐛 29 | 🌐 Go | 📅 2026-08-29 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 948 | 🐛 67 | 🌐 Python | 📅 2026-08-29 - Add multi-language support (Python) to your dbt project.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,401 | 🐛 24 | 🌐 HTML | 📅 2026-08-27 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,863 | 🐛 340 | 🌐 Python | 📅 2026-08-28 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 803 | 🐛 271 | 🌐 TypeScript | 📅 2026-08-29 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 38 | 🌐 Python | 📅 2026-08-28 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-score](https://github.com/PicnicSupermarket/dbt-score) ⭐ 246 | 🐛 14 | 🌐 Python | 📅 2026-08-26 - Linter for dbt metadata.
...
* [dlin](https://github.com/eitsupi/dlin) ⭐ 14 | 🐛 1 | 🌐 Rust | 📅 2026-08-29 - Gives coding agents instant dbt lineage: no dbt compile, no Python, no grep. Fast model-level lineage CLI parsing SQL files directly (or a `manifest.json`), with experimental column-level lineage too.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 205 | 🐛 13 | 🌐 PLSQL | 📅 2026-08-28 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 210 | 🐛 204 | 🌐 JavaScript | 📅 2026-08-28 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 485 | 🐛 52 | 🌐 Python | 📅 2026-08-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
