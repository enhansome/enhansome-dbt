...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,729 | 🐛 2 | 📅 2026-09-05 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,786 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 217 | 🐛 222 | 🌐 JavaScript | 📅 2026-09-24 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,158 | 🐛 1,120 | 🌐 TypeScript | 📅 2026-09-24 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,975 | 🐛 19 | 🌐 Go | 📅 2026-09-24 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 961 | 🐛 79 | 🌐 Python | 📅 2026-09-23 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 726 | 🐛 30 | 🌐 Python | 📅 2026-09-24 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 608 | 🐛 51 | 🌐 Python | 📅 2026-09-24 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,413 | 🐛 15 | 🌐 HTML | 📅 2026-09-24 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,892 | 🐛 340 | 🌐 Python | 📅 2026-09-23 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 813 | 🐛 305 | 🌐 TypeScript | 📅 2026-09-24 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 38 | 🌐 Python | 📅 2026-09-21 - This tool formats your dbt SQL code so you don't have to.
...
* [ERD Studio](https://github.com/liam-machine/erd-studio) ⭐ 154 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-24 - VS Code extension that puts a visual ERD designer inside your dbt repo. Two-stage (logical/physical) canvas, drift detection against `manifest.json`, auto-generated `selectors.yml`, and AI-readable semantic models (YAML/JSON) with a built-in harness for Claude, Copilot, Gemini, and Codex.
* [dbtpal](https://github.com/PedramNavid/dbtpal) ⭐ 138 | 🐛 10 | 🌐 Lua | 📅 2025-06-19 - A Neovim plugin for dbt model editing.
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 133 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-doctor](https://github.com/joachimhodana/dbt-doctor) ⭐ 64 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - CLI health check and linter for dbt projects (SQL, YAML, Jinja): 190+ custom rules, optional SQLFluff, 0–100 score, GitHub Actions CI, and coding-agent skills.
...
* [dbt-column-lineage](https://github.com/Oisix/dbt-column-lineage) ⭐ 1 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-16 - Tool to visualize the column level lineage of dbt models.
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 134 | 🌐 Python | 📅 2026-09-24 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 577 | 🐛 26 | 🌐 Shell | 📅 2026-09-02 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 208 | 🐛 15 | 🌐 PLSQL | 📅 2026-09-24 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 217 | 🐛 222 | 🌐 JavaScript | 📅 2026-09-24 - Revamped and ported hub of main discussions for the community.
...
* [awesome-public-dbt-projects](https://github.com/InfuseAI/awesome-public-dbt-projects) ⭐ 220 | 🐛 2 | 📅 2023-12-28 - A curated list of awesome public dbt projects.
