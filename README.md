...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,274 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 212 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,119 | 🐛 1,042 | 🌐 TypeScript | 📅 2026-09-05 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,944 | 🐛 22 | 🌐 Go | 📅 2026-09-05 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 959 | 🐛 71 | 🌐 Python | 📅 2026-09-04 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 700 | 🐛 41 | 🌐 Python | 📅 2026-09-03 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,406 | 🐛 25 | 🌐 HTML | 📅 2026-09-03 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 68 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,865 | 🐛 329 | 🌐 Python | 📅 2026-09-05 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 805 | 🐛 268 | 🌐 TypeScript | 📅 2026-09-05 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [vscode-dbt-power-user](https://github.com/innoverio/vscode-dbt-power-user) ⭐ 585 | 🐛 162 | 🌐 JavaScript | 📅 2026-09-04 - VSCode extension to give more clarity on model dependencies.
...
* [dbterd](https://github.com/datnguye/dbterd) ⭐ 345 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - CLI to generate DBML file from dbt manifest.json.
* [dbt-score](https://github.com/PicnicSupermarket/dbt-score) ⭐ 247 | 🐛 19 | 🌐 Python | 📅 2026-09-01 - Linter for dbt metadata.
* [dbt-loom](https://github.com/nicholasyager/dbt-loom) ⭐ 221 | 🐛 26 | 🌐 Python | 📅 2026-06-25 - A dbt-core plugin to weave together multi-project dbt-core deployments.
...
* [dbt-doctor](https://github.com/joachimhodana/dbt-doctor) ⭐ 59 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - CLI health check and linter for dbt projects (SQL, YAML, Jinja): 190+ custom rules, optional SQLFluff, 0–100 score, GitHub Actions CI, and coding-agent skills.
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 116 | 🌐 Python | 📅 2026-09-05 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-artifacts](https://github.com/brooklyn-data/dbt_artifacts) ⭐ 405 | 🐛 84 | 🌐 Shell | 📅 2026-08-10 - This package builds a mart of tables from dbt artifacts loaded into a table.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 212 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 494 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
