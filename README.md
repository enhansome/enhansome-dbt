...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 44,776 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 209 | 🐛 204 | 🌐 JavaScript | 📅 2026-08-20 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,062 | 🐛 1,172 | 🌐 TypeScript | 📅 2026-08-20 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,850 | 🐛 16 | 🌐 Go | 📅 2026-08-19 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 946 | 🐛 70 | 🌐 Python | 📅 2026-08-20 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 678 | 🐛 39 | 🌐 Python | 📅 2026-08-20 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 598 | 🐛 36 | 🌐 Python | 📅 2026-08-20 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,395 | 🐛 25 | 🌐 HTML | 📅 2026-08-20 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,859 | 🐛 332 | 🌐 Python | 📅 2026-08-18 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 793 | 🐛 231 | 🌐 TypeScript | 📅 2026-08-20 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 545 | 🐛 38 | 🌐 Python | 📅 2026-08-18 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 126 | 🐛 11 | 🌐 Python | 📅 2026-08-20 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 114 | 🐛 6 | 🌐 Python | 📅 2026-08-20 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
* [fzf-dbt](https://github.com/Infused-Insight/fzf-dbt) ⭐ 74 | 🐛 2 | 🌐 Shell | 📅 2023-07-26 - Search dbt models interactively from terminal.
* [dbt-Workbench](https://github.com/rezer-bleede/dbt-Workbench) ⭐ 70 | 🐛 0 | 🌐 Python | 📅 2026-05-30 - An open UI for dbt providing model browsing, lineage visualization, run orchestration, documentation, environment management — without vendor lock-in. Designed for local, on‑prem, and air‑gapped deployments.
...
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 572 | 🐛 20 | 🌐 Shell | 📅 2026-07-30 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 201 | 🐛 15 | 🌐 PLSQL | 📅 2026-08-19 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [dbt-fabric](https://github.com/microsoft/dbt-fabric) ⭐ 145 | 🐛 35 | 🌐 Python | 📅 2026-08-20 - A dbt adapter for working with Microsoft Fabric Data Warehouses.
* [dbt-meta-testing](https://github.com/tnightengale/dbt-meta-testing) ⭐ 131 | 🐛 10 | 🌐 SQL | 📅 2026-04-16 - Yet another coverage testing.
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 116 | 🐛 18 | 🌐 Go | 📅 2026-08-12 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 64 | 🐛 4 | 🌐 Python | 📅 2026-08-20 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 209 | 🐛 204 | 🌐 JavaScript | 📅 2026-08-20 - Revamped and ported hub of main discussions for the community.
