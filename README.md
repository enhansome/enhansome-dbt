...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,585 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 215 | 🐛 224 | 🌐 JavaScript | 📅 2026-09-16 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,140 | 🐛 1,056 | 🌐 TypeScript | 📅 2026-09-16 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,966 | 🐛 20 | 🌐 Go | 📅 2026-09-16 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 960 | 🐛 80 | 🌐 Python | 📅 2026-09-16 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 714 | 🐛 31 | 🌐 Python | 📅 2026-09-16 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 605 | 🐛 45 | 🌐 Python | 📅 2026-09-16 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,409 | 🐛 12 | 🌐 HTML | 📅 2026-09-16 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-09-04 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,875 | 🐛 333 | 🌐 Python | 📅 2026-09-13 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 811 | 🐛 296 | 🌐 TypeScript | 📅 2026-09-16 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [dbt-osmosis](https://github.com/z3z1ma/dbt-osmosis) ⭐ 640 | 🐛 14 | 🌐 Python | 📅 2026-08-15 - Enhance the developer experience significantly with workbench, output diffs, and YAML management.
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 38 | 🌐 Python | 📅 2026-09-14 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-score](https://github.com/PicnicSupermarket/dbt-score) ⭐ 247 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - Linter for dbt metadata.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 132 | 🐛 9 | 🌐 Python | 📅 2026-09-16 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 117 | 🐛 10 | 🌐 Python | 📅 2026-09-03 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
...
* [dbt-doctor](https://github.com/joachimhodana/dbt-doctor) ⭐ 62 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - CLI health check and linter for dbt projects (SQL, YAML, Jinja): 190+ custom rules, optional SQLFluff, 0–100 score, GitHub Actions CI, and coding-agent skills.
...
* [datapilot](https://github.com/AltimateAI/datapilot) ⭐ 43 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - AI teammate for engineers to ensure best practices in their SQL.
...
* [dlin](https://github.com/eitsupi/dlin) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 - Gives coding agents instant dbt lineage: no dbt compile, no Python, no grep. Fast model-level lineage CLI parsing SQL files directly (or a `manifest.json`), with experimental column-level lineage too.
...
* [ERD Studio](https://github.com/liam-machine/erd-studio) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-15 - VS Code extension that puts a visual ERD designer inside your dbt repo. Two-stage (logical/physical) canvas, drift detection against `manifest.json`, auto-generated `selectors.yml`, and AI-readable semantic models (YAML/JSON) with a built-in harness for Claude, Copilot, Gemini, and Codex.
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 126 | 🌐 Python | 📅 2026-09-16 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-metabase](https://github.com/gouline/dbt-metabase) ⭐ 615 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Model synchronization from dbt to Metabase.
...
* [dbt-fabric](https://github.com/microsoft/dbt-fabric) ⭐ 148 | 🐛 34 | 🌐 Python | 📅 2026-09-14 - A dbt adapter for working with Microsoft Fabric Data Warehouses.
* [dbt-meta-testing](https://github.com/tnightengale/dbt-meta-testing) ⭐ 132 | 🐛 10 | 🌐 SQL | 📅 2026-04-16 - Yet another coverage testing.
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 20 | 🌐 Go | 📅 2026-09-16 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 215 | 🐛 224 | 🌐 JavaScript | 📅 2026-09-16 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 503 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
* [awesome-public-dbt-projects](https://github.com/InfuseAI/awesome-public-dbt-projects) ⭐ 218 | 🐛 2 | 📅 2023-12-28 - A curated list of awesome public dbt projects.
