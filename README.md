...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,730 | 🐛 2 | 📅 2026-09-05 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,814 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 217 | 🐛 223 | 🌐 JavaScript | 📅 2026-09-25 - Automatically generate ERDs and display in your docs site.
* [Business Intelligence Standards](https://github.com/flexanalytics/dbt-business-intelligence) ⭐ 159 | 🐛 5 | 🌐 Python | 📅 2026-04-30 - Best practices in Business Intelligence standards for integrating with dbt.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,162 | 🐛 1,092 | 🌐 TypeScript | 📅 2026-09-25 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,977 | 🐛 20 | 🌐 Go | 📅 2026-09-25 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 961 | 🐛 80 | 🌐 Python | 📅 2026-09-23 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 726 | 🐛 31 | 🌐 Python | 📅 2026-09-24 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 608 | 🐛 45 | 🌐 Python | 📅 2026-09-25 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,413 | 🐛 16 | 🌐 HTML | 📅 2026-09-24 - A dbt package that provides data anomaly detection as dbt tests.
* [dbt-expectations](https://github.com/calogica/dbt-expectations) ⭐ 1,234 | 🐛 37 | 🌐 Shell | 📅 2024-12-16 - Port between dbt and great\_expectations to extend out-of-the-box tests.
* [DataKitchen Open Source Data Observability](https://github.com/DataKitchen/data-observability-installer) ⭐ 141 | 🐛 7 | 🌐 Python | 📅 2026-09-22 - Data breaks. Servers break. dbt and other tools break. Observability and alerting across and down your data estate. Save time with simple, fast data quality test generation and execution.
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 69 | 🐛 0 | 🌐 Python | 📅 2026-09-16 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
* [dq-tools](https://github.com/infinitelambda/dq-tools) ⭐ 58 | 🐛 1 | 🌐 PLpgSQL | 📅 2026-08-21 - Make simple storing test results and visualisation of these in a BI dashboard leveraging 6 Data Quality KPIs.
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 10 | 🐛 13 | 🌐 Python | 📅 2026-09-24 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
* [data-contract-validator](https://github.com/OGsiji/data-contract-validator) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-08-15 - Fails the pull request when a model stops producing what a downstream consumer expects. Reads columns from `catalog.json`/`manifest.json` (falling back to a sqlglot parse of the SQL) and compares them against reverse-ETL destinations such as HubSpot CRM and against FastAPI/Pydantic services, in CI or pre-commit.
...
* [dbt-ci-cd](https://github.com/bruno-szdl/dbt-ci-cd) ⭐ 189 | 🐛 3 | 📅 2025-08-24 - This setup is designed to demonstrate and implement best practices for testing and deploying dbt models.
* [dbt-beyond-the-basics](https://github.com/pgoslatara/dbt-beyond-the-basics) ⭐ 108 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Showcase of advanced options when running CI for dbt.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,894 | 🐛 348 | 🌐 Python | 📅 2026-09-23 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 813 | 🐛 308 | 🌐 TypeScript | 📅 2026-09-25 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
* [Pre-commit hooks](https://github.com/dbt-checkpoint/dbt-checkpoint) ⭐ 768 | 🐛 70 | 🌐 Python | 📅 2026-08-17 - Pre-commit hooks for checking data integity before schema change commit.
* [dbt-osmosis](https://github.com/z3z1ma/dbt-osmosis) ⭐ 643 | 🐛 14 | 🌐 Python | 📅 2026-08-15 - Enhance the developer experience significantly with workbench, output diffs, and YAML management.
* [vscode-dbt-power-user](https://github.com/innoverio/vscode-dbt-power-user) ⭐ 586 | 🐛 156 | 🌐 JavaScript | 📅 2026-09-16 - VSCode extension to give more clarity on model dependencies.
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 548 | 🐛 38 | 🌐 Python | 📅 2026-09-24 - This tool formats your dbt SQL code so you don't have to.
...
* [dbterd](https://github.com/datnguye/dbterd) ⭐ 346 | 🐛 2 | 🌐 Python | 📅 2026-09-06 - CLI to generate DBML file from dbt manifest.json.
* [dbt-score](https://github.com/PicnicSupermarket/dbt-score) ⭐ 247 | 🐛 14 | 🌐 Python | 📅 2026-09-23 - Linter for dbt metadata.
* [dbt-loom](https://github.com/nicholasyager/dbt-loom) ⭐ 226 | 🐛 25 | 🌐 Python | 📅 2026-09-23 - A dbt-core plugin to weave together multi-project dbt-core deployments.
* [dbt-column-lineage-extractor](https://github.com/canva-public/dbt-column-lineage-extractor) ⭐ 212 | 🐛 4 | 🌐 Python | 📅 2025-03-28 - Extract column level linage from dbt projects.
* [dbt-llm-tools](https://github.com/pragunbhutani/dbt-llm-tools) ⭐ 180 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - RAG based LLM chatbot for dbt projects.
* [ERD Studio](https://github.com/liam-machine/erd-studio) ⭐ 157 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - VS Code extension that puts a visual ERD designer inside your dbt repo. Two-stage (logical/physical) canvas, drift detection against `manifest.json`, auto-generated `selectors.yml`, and AI-readable semantic models (YAML/JSON) with a built-in harness for Claude, Copilot, Gemini, and Codex.
* [dbtpal](https://github.com/PedramNavid/dbtpal) ⭐ 138 | 🐛 10 | 🌐 Lua | 📅 2025-06-19 - A Neovim plugin for dbt model editing.
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 133 | 🐛 4 | 🌐 Python | 📅 2026-09-25 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-ui](https://github.com/data-diving/dbt-ui) ⭐ 126 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-01 - A modern web-based user interface for dbt-core projects
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 118 | 🐛 13 | 🌐 Python | 📅 2026-09-24 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
* [fzf-dbt](https://github.com/Infused-Insight/fzf-dbt) ⭐ 73 | 🐛 2 | 🌐 Shell | 📅 2023-07-26 - Search dbt models interactively from terminal.
* [dbt-Workbench](https://github.com/rezer-bleede/dbt-Workbench) ⭐ 72 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - An open UI for dbt providing model browsing, lineage visualization, run orchestration, documentation, environment management — without vendor lock-in. Designed for local, on‑prem, and air‑gapped deployments.
* [dbt-doctor](https://github.com/joachimhodana/dbt-doctor) ⭐ 65 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - CLI health check and linter for dbt projects (SQL, YAML, Jinja): 190+ custom rules, optional SQLFluff, 0–100 score, GitHub Actions CI, and coding-agent skills.
...
* [dbtective](https://github.com/feliblo/dbtective) ⭐ 45 | 🐛 2 | 🌐 Rust | 📅 2026-09-24 Rust-powered 'detective'/linter for dbt project/metadata best practices
* [datapilot](https://github.com/AltimateAI/datapilot) ⭐ 43 | 🐛 5 | 🌐 Python | 📅 2026-09-16 - AI teammate for engineers to ensure best practices in their SQL.
...
* [dbt-command-center](https://github.com/montara-io/dbt-command-center) ⭐ 32 | 🐛 9 | 🌐 TypeScript | 📅 2025-04-20 - A local web application that provides a user-friendly interface to monitor and manage dbt runs.
...
* [dlin](https://github.com/eitsupi/dlin) ⭐ 16 | 🐛 2 | 🌐 Rust | 📅 2026-09-24 - Gives coding agents instant dbt lineage: no dbt compile, no Python, no grep. Fast model-level lineage CLI parsing SQL files directly (or a `manifest.json`), with experimental column-level lineage too.
...
* [sqllens](https://github.com/NiclasOlofsson/sqllens) ⭐ 4 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-14 - TypeScript SQL parser and static analyzer: type inference, schema diagnostics, and column-level lineage. Reads Jinja-templated SQL (dbt models) natively, without rendering.
...
* [dbt-column-lineage](https://github.com/Oisix/dbt-column-lineage) ⭐ 1 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-25 - Tool to visualize the column level lineage of dbt models.
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 133 | 🌐 Python | 📅 2026-09-25 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-metabase](https://github.com/gouline/dbt-metabase) ⭐ 617 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Model synchronization from dbt to Metabase.
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 577 | 🐛 26 | 🌐 Shell | 📅 2026-09-25 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
* [dbt-unit-testing](https://github.com/EqualExperts/dbt-unit-testing) ⭐ 448 | 🐛 26 | 🌐 Shell | 📅 2026-05-13 -  Package which contains macros to support unit testing.
* [dbt\_audit\_helper](https://github.com/dbt-labs/dbt-audit-helper/) ⭐ 424 | 🐛 11 | 📅 2026-05-19 - Macros for data audits that compare columns values and schemas between tables.
* [dbt-artifacts](https://github.com/brooklyn-data/dbt_artifacts) ⭐ 403 | 🐛 91 | 🌐 Shell | 📅 2026-09-23 - This package builds a mart of tables from dbt artifacts loaded into a table.
* [dbt-external-tables](https://github.com/dbt-labs/dbt-external-tables) ⭐ 384 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-24 - Macros to stage your external sources.
* [dbt-snowflake-monitoring](https://github.com/get-select/dbt-snowflake-monitoring) ⭐ 262 | 🐛 32 | 📅 2026-03-18 - A dbt package to help you monitor Snowflake performance and costs.
* [dbt-coverage](https://github.com/slidoapp/dbt-coverage) ⭐ 242 | 🐛 17 | 🌐 Python | 📅 2026-04-29 - Checks dbt docs and tests coverage.
* [dbt\_metrics](https://github.com/dbt-labs/dbt_metrics) ⭐ 222 | 🐛 0 | 🌐 Python | 📅 2025-12-17 - Macros to support secondary calculations and generate business metrics.
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 208 | 🐛 16 | 🌐 PLSQL | 📅 2026-09-25 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [dbt\_constraints](https://github.com/Snowflake-Labs/dbt_constraints) ⭐ 177 | 🐛 13 | 🌐 SQL | 📅 2026-09-03 - Generate database constraints based on the tests in a dbt project.
* [dbt-superset-lineage](https://github.com/slidoapp/dbt-superset-lineage) ⭐ 155 | 🐛 3 | 🌐 Python | 📅 2026-02-12 - Push and pull metadata between dbt to Superset.
* [dbt-fabric](https://github.com/microsoft/dbt-fabric) ⭐ 149 | 🐛 34 | 🌐 Python | 📅 2026-09-22 - A dbt adapter for working with Microsoft Fabric Data Warehouses.
* [dbt-meta-testing](https://github.com/tnightengale/dbt-meta-testing) ⭐ 132 | 🐛 10 | 🌐 SQL | 📅 2026-04-16 - Yet another coverage testing.
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 21 | 🌐 Go | 📅 2026-09-24 - IAC in dbt Cloud via Terraform.
* [dbt-excel](https://github.com/godatadriven/dbt-excel) ⭐ 97 | 🐛 10 | 🌐 Python | 📅 2026-03-12 - A dbt adapter for working with Excel.
* [dbt\_linreg](https://github.com/dwreeves/dbt_linreg) ⭐ 79 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Linear regression in SQL using dbt.
...
* [dbt-snow-mask](https://github.com/entechlog/dbt-snow-mask) ⭐ 70 | 🐛 31 | 📅 2026-03-15 - A dbt package for Snowflake Dynamic Data Masking.
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 3 | 🌐 Python | 📅 2026-09-25 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [dbt-testgen](https://github.com/kgmcquate/dbt-testgen) ⭐ 38 | 🐛 6 | 🌐 Shell | 📅 2024-02-28 - Generate dbt tests based on sample data.
* [dbt-feature-store](https://github.com/fal-ai/dbt_feature_store) ⭐ 38 | 🐛 1 | 🌐 Python | 📅 2022-12-16 - Macros to build a feature store right within your dbt project.
...
* [dbt-fivetran-utils](https://github.com/fivetran/dbt_fivetran_utils) ⭐ 33 | 🐛 21 | 🌐 Shell | 📅 2026-09-25 - General macros and helpers.
...
* [dbt-date](https://github.com/godatadriven/dbt-date) ⭐ 30 | 🐛 3 | 🌐 Python | 📅 2026-09-02 - Date logic and calendar functionality.
...
* [dbt-tags](https://github.com/infinitelambda/dbt-tags) ⭐ 26 | 🐛 1 | 📅 2026-08-31 - Tag-based masking policies management in Snowflake.
...
* [dbt-census-utils](https://github.com/sutrolabs/dbt_census_utils) ⭐ 0 | 🐛 3 | 📅 2026-03-30 - A collection of dbt macros for working with Census data.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 217 | 🐛 223 | 🌐 JavaScript | 📅 2026-09-25 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 510 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
* [awesome-public-dbt-projects](https://github.com/InfuseAI/awesome-public-dbt-projects) ⭐ 219 | 🐛 2 | 📅 2023-12-28 - A curated list of awesome public dbt projects.
* [airflow-dbt-demo](https://github.com/astronomer/airflow-dbt-demo) ⭐ 187 | 🐛 8 | 🌐 Python | 📅 2023-08-23 - Demonstration of Airflow integration.
...
* [dbt-snowflake-template](https://github.com/collinrlenon/dbt-snowflake-template) ⭐ 11 | 🐛 0 | 📅 2025-03-06 - Production-ready template deploying dbt project to Snowflake using GH Actions.
