...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,721 | 🐛 8 | 📅 2026-08-07 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 44,812 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 209 | 🐛 206 | 🌐 JavaScript | 📅 2026-08-21 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,071 | 🐛 1,193 | 🌐 TypeScript | 📅 2026-08-22 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,856 | 🐛 15 | 🌐 Go | 📅 2026-08-21 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 946 | 🐛 69 | 🌐 Python | 📅 2026-08-22 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 681 | 🐛 39 | 🌐 Python | 📅 2026-08-21 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 598 | 🐛 36 | 🌐 Python | 📅 2026-08-21 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,396 | 🐛 26 | 🌐 HTML | 📅 2026-08-22 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 68 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,860 | 🐛 329 | 🌐 Python | 📅 2026-08-22 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 794 | 🐛 232 | 🌐 TypeScript | 📅 2026-08-22 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 546 | 🐛 38 | 🌐 Python | 📅 2026-08-18 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 127 | 🐛 6 | 🌐 Python | 📅 2026-08-21 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-fabric](https://github.com/microsoft/dbt-fabric) ⭐ 146 | 🐛 36 | 🌐 Python | 📅 2026-08-20 - A dbt adapter for working with Microsoft Fabric Data Warehouses.
* [dbt-meta-testing](https://github.com/tnightengale/dbt-meta-testing) ⭐ 131 | 🐛 10 | 🌐 SQL | 📅 2026-04-16 - Yet another coverage testing.
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 116 | 🐛 18 | 🌐 Go | 📅 2026-08-21 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 64 | 🐛 3 | 🌐 Python | 📅 2026-08-22 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 209 | 🐛 206 | 🌐 JavaScript | 📅 2026-08-21 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 475 | 🐛 51 | 🌐 Python | 📅 2026-08-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
