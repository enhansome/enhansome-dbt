...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,764 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 217 | 🐛 222 | 🌐 JavaScript | 📅 2026-09-23 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,154 | 🐛 1,138 | 🌐 TypeScript | 📅 2026-09-23 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,974 | 🐛 19 | 🌐 Go | 📅 2026-09-23 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 961 | 🐛 79 | 🌐 Python | 📅 2026-09-23 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 726 | 🐛 30 | 🌐 Python | 📅 2026-09-23 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 610 | 🐛 51 | 🌐 Python | 📅 2026-09-23 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,413 | 🐛 13 | 🌐 HTML | 📅 2026-09-23 - A dbt package that provides data anomaly detection as dbt tests.
...
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 13 | 🌐 Python | 📅 2026-09-23 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,889 | 🐛 338 | 🌐 Python | 📅 2026-09-23 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 813 | 🐛 301 | 🌐 TypeScript | 📅 2026-09-23 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [dbt-loom](https://github.com/nicholasyager/dbt-loom) ⭐ 224 | 🐛 25 | 🌐 Python | 📅 2026-09-23 - A dbt-core plugin to weave together multi-project dbt-core deployments.
...
* [ERD Studio](https://github.com/liam-machine/erd-studio) ⭐ 149 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - VS Code extension that puts a visual ERD designer inside your dbt repo. Two-stage (logical/physical) canvas, drift detection against `manifest.json`, auto-generated `selectors.yml`, and AI-readable semantic models (YAML/JSON) with a built-in harness for Claude, Copilot, Gemini, and Codex.
* [dbtpal](https://github.com/PedramNavid/dbtpal) ⭐ 138 | 🐛 10 | 🌐 Lua | 📅 2025-06-19 - A Neovim plugin for dbt model editing.
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 133 | 🐛 7 | 🌐 Python | 📅 2026-09-22 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 118 | 🐛 12 | 🌐 Python | 📅 2026-09-19 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
...
* [dbtective](https://github.com/feliblo/dbtective) ⭐ 45 | 🐛 2 | 🌐 Rust | 📅 2026-09-23 Rust-powered 'detective'/linter for dbt project/metadata best practices
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 126 | 🌐 Python | 📅 2026-09-23 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-metabase](https://github.com/gouline/dbt-metabase) ⭐ 617 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Model synchronization from dbt to Metabase.
...
* [dbt-artifacts](https://github.com/brooklyn-data/dbt_artifacts) ⭐ 403 | 🐛 89 | 🌐 Shell | 📅 2026-09-23 - This package builds a mart of tables from dbt artifacts loaded into a table.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 208 | 🐛 15 | 🌐 PLSQL | 📅 2026-09-23 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 19 | 🌐 Go | 📅 2026-09-23 - IAC in dbt Cloud via Terraform.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 217 | 🐛 222 | 🌐 JavaScript | 📅 2026-09-23 - Revamped and ported hub of main discussions for the community.
