...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,605 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 215 | 🐛 228 | 🌐 JavaScript | 📅 2026-09-17 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,139 | 🐛 1,095 | 🌐 TypeScript | 📅 2026-09-17 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,968 | 🐛 21 | 🌐 Go | 📅 2026-09-16 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 960 | 🐛 80 | 🌐 Python | 📅 2026-09-17 - Add multi-language support (Python) to your dbt project.
...
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 606 | 🐛 46 | 🌐 Python | 📅 2026-09-17 - MCP tools to interact with dbt.
...
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 5 | 🌐 Python | 📅 2026-09-17 - Zero-config data quality CLI that complements `dbt test` with auto-detected anomalies (volume, schema drift, freshness, distribution, cardinality) on every materialized model after `dbt run`.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,877 | 🐛 329 | 🌐 Python | 📅 2026-09-17 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 812 | 🐛 296 | 🌐 TypeScript | 📅 2026-09-17 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 139 | 🌐 Python | 📅 2026-09-17 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-fabric](https://github.com/microsoft/dbt-fabric) ⭐ 148 | 🐛 34 | 🌐 Python | 📅 2026-09-17 - A dbt adapter for working with Microsoft Fabric Data Warehouses.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 3 | 🌐 Python | 📅 2026-09-17 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 215 | 🐛 228 | 🌐 JavaScript | 📅 2026-09-17 - Revamped and ported hub of main discussions for the community.
