...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,179 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-09-02 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 211 | 🐛 215 | 🌐 JavaScript | 📅 2026-09-02 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,116 | 🐛 1,051 | 🌐 TypeScript | 📅 2026-09-02 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,935 | 🐛 25 | 🌐 Go | 📅 2026-09-02 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 958 | 🐛 68 | 🌐 Python | 📅 2026-09-02 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 699 | 🐛 41 | 🌐 Python | 📅 2026-09-01 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 602 | 🐛 40 | 🌐 Python | 📅 2026-09-02 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,405 | 🐛 26 | 🌐 HTML | 📅 2026-09-02 - A dbt package that provides data anomaly detection as dbt tests.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,864 | 🐛 330 | 🌐 Python | 📅 2026-09-02 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 803 | 🐛 279 | 🌐 TypeScript | 📅 2026-09-02 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 129 | 🐛 9 | 🌐 Python | 📅 2026-09-02 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 574 | 🐛 23 | 🌐 Shell | 📅 2026-09-02 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
...
* [dbt\_constraints](https://github.com/Snowflake-Labs/dbt_constraints) ⭐ 177 | 🐛 13 | 🌐 SQL | 📅 2026-09-02 - Generate database constraints based on the tests in a dbt project.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 20 | 🌐 Go | 📅 2026-09-02 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 67 | 🐛 4 | 🌐 Python | 📅 2026-09-02 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 211 | 🐛 215 | 🌐 JavaScript | 📅 2026-09-02 - Revamped and ported hub of main discussions for the community.
