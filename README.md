...
Any kind of contribution is greatly encouraged and appreciated. For making a contribution, **please check the [contribution guidelines](https://github.com/Hiflylabs/awesome-dbt/blob/main/contributing.md) ⭐ 1,723 | 🐛 1 | 📅 2026-09-05 first!** **Add new entries on the top of sections** (LIFO) to keep fresh items more visible! Also, **feel free to add new sections**.
...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,326 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-07 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 212 | 🐛 215 | 🌐 JavaScript | 📅 2026-09-07 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,121 | 🐛 1,029 | 🌐 TypeScript | 📅 2026-09-07 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,949 | 🐛 21 | 🌐 Go | 📅 2026-09-07 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 959 | 🐛 71 | 🌐 Python | 📅 2026-09-07 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 704 | 🐛 41 | 🌐 Python | 📅 2026-09-06 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 603 | 🐛 39 | 🌐 Python | 📅 2026-09-07 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,406 | 🐛 19 | 🌐 HTML | 📅 2026-09-07 - A dbt package that provides data anomaly detection as dbt tests.
* [dbt-expectations](https://github.com/calogica/dbt-expectations) ⭐ 1,232 | 🐛 37 | 🌐 Shell | 📅 2024-12-16 - Port between dbt and great\_expectations to extend out-of-the-box tests.
* [DataKitchen Open Source Data Observability](https://github.com/DataKitchen/data-observability-installer) ⭐ 141 | 🐛 6 | 🌐 Python | 📅 2026-09-03 - Data breaks. Servers break. dbt and other tools break. Observability and alerting across and down your data estate. Save time with simple, fast data quality test generation and execution.
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 68 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [dbt-beyond-the-basics](https://github.com/pgoslatara/dbt-beyond-the-basics) ⭐ 106 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Showcase of advanced options when running CI for dbt.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,866 | 🐛 322 | 🌐 Python | 📅 2026-09-07 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 809 | 🐛 266 | 🌐 TypeScript | 📅 2026-09-07 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
* [Pre-commit hooks](https://github.com/dbt-checkpoint/dbt-checkpoint) ⭐ 766 | 🐛 67 | 🌐 Python | 📅 2026-08-17 - Pre-commit hooks for checking data integity before schema change commit.
...
* [vscode-dbt-power-user](https://github.com/innoverio/vscode-dbt-power-user) ⭐ 585 | 🐛 162 | 🌐 JavaScript | 📅 2026-09-07 - VSCode extension to give more clarity on model dependencies.
* [sqlfmt](https://github.com/tconbeer/sqlfmt) ⭐ 547 | 🐛 38 | 🌐 Python | 📅 2026-09-07 - This tool formats your dbt SQL code so you don't have to.
...
* [dbt-loom](https://github.com/nicholasyager/dbt-loom) ⭐ 222 | 🐛 26 | 🌐 Python | 📅 2026-09-06 - A dbt-core plugin to weave together multi-project dbt-core deployments.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 132 | 🐛 7 | 🌐 Python | 📅 2026-09-03 - Tool to configure and enforce conventions for your dbt project.
...
* [dbt-artifacts-parser](https://github.com/yu-iskw/dbt-artifacts-parser) ⭐ 116 | 🐛 10 | 🌐 Python | 📅 2026-09-03 -  It enables us to deal with catalog.json, manifest.json, run-results.json and sources.json as python objects.
...
* [dbt-doctor](https://github.com/joachimhodana/dbt-doctor) ⭐ 60 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-14 - CLI health check and linter for dbt projects (SQL, YAML, Jinja): 190+ custom rules, optional SQLFluff, 0–100 score, GitHub Actions CI, and coding-agent skills.
...
* [dlin](https://github.com/eitsupi/dlin) ⭐ 15 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 - Gives coding agents instant dbt lineage: no dbt compile, no Python, no grep. Fast model-level lineage CLI parsing SQL files directly (or a `manifest.json`), with experimental column-level lineage too.
...
* [ERD Studio](https://github.com/liam-machine/erd-studio) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-07 - VS Code extension that puts a visual ERD designer inside your dbt repo. Two-stage (logical/physical) canvas, drift detection against `manifest.json`, auto-generated `selectors.yml`, and AI-readable semantic models (YAML/JSON) with a built-in harness for Claude, Copilot, Gemini, and Codex.
...
* [sqllens](https://github.com/NiclasOlofsson/sqllens) ⭐ 3 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-26 - TypeScript SQL parser and static analyzer: type inference, schema diagnostics, and column-level lineage. Reads Jinja-templated SQL (dbt models) natively, without rendering.
...
* [dbt-column-lineage](https://github.com/Oisix/dbt-column-lineage) ⭐ 1 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-07 - Tool to visualize the column level lineage of dbt models.
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 87 | 🌐 Python | 📅 2026-09-07 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-codegen](https://github.com/dbt-labs/dbt-codegen) ⭐ 674 | 🐛 24 | 🌐 Makefile | 📅 2026-07-28 - Macros that generate dbt code, and log it to the command line.
* [dbt-metabase](https://github.com/gouline/dbt-metabase) ⭐ 613 | 🐛 1 | 🌐 Python | 📅 2026-09-02 - Model synchronization from dbt to Metabase.
* [dbt-project-evaluator](https://github.com/dbt-labs/dbt-project-evaluator) ⭐ 575 | 🐛 23 | 🌐 Shell | 📅 2026-09-02 - This package highlights areas of a dbt project that are misaligned with dbt Labs' best practices.
...
* [dbt-artifacts](https://github.com/brooklyn-data/dbt_artifacts) ⭐ 404 | 🐛 84 | 🌐 Shell | 📅 2026-08-10 - This package builds a mart of tables from dbt artifacts loaded into a table.
* [dbt-external-tables](https://github.com/dbt-labs/dbt-external-tables) ⭐ 382 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Macros to stage your external sources.
* [dbt-snowflake-monitoring](https://github.com/get-select/dbt-snowflake-monitoring) ⭐ 261 | 🐛 33 | 📅 2026-03-18 - A dbt package to help you monitor Snowflake performance and costs.
* [dbt-coverage](https://github.com/slidoapp/dbt-coverage) ⭐ 241 | 🐛 17 | 🌐 Python | 📅 2026-04-29 - Checks dbt docs and tests coverage.
...
* [datavault4dbt](https://github.com/ScalefreeCOM/datavault4dbt) ⭐ 206 | 🐛 12 | 🌐 PLSQL | 📅 2026-08-28 - Macros for staging and creation of all DataVault-Entities you need, to build your own DataVault2.0 solution.
...
* [dbt-fabric](https://github.com/microsoft/dbt-fabric) ⭐ 148 | 🐛 34 | 🌐 Python | 📅 2026-08-26 - A dbt adapter for working with Microsoft Fabric Data Warehouses.
* [dbt-meta-testing](https://github.com/tnightengale/dbt-meta-testing) ⭐ 132 | 🐛 10 | 🌐 SQL | 📅 2026-04-16 - Yet another coverage testing.
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 17 | 🌐 Go | 📅 2026-09-07 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 68 | 🐛 4 | 🌐 Python | 📅 2026-09-03 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 212 | 🐛 215 | 🌐 JavaScript | 📅 2026-09-07 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 496 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
* [awesome-public-dbt-projects](https://github.com/InfuseAI/awesome-public-dbt-projects) ⭐ 216 | 🐛 2 | 📅 2023-12-28 - A curated list of awesome public dbt projects.
...
* [dbt-snowflake-template](https://github.com/collinrlenon/dbt-snowflake-template) ⭐ 9 | 🐛 0 | 📅 2025-03-06 - Production-ready template deploying dbt project to Snowflake using GH Actions.
