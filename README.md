...
* [Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) ⭐ 45,566 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Data engineering course on cutting edge tools including dbt.
...
* [Automatically generate ERD](https://github.com/dbt-labs/docs.getdbt.com/discussions/1541) ⭐ 215 | 🐛 231 | 🌐 JavaScript | 📅 2026-09-15 - Automatically generate ERDs and display in your docs site.
...
* [Lightdash](https://github.com/lightdash/lightdash) ⭐ 6,138 | 🐛 1,055 | 🌐 TypeScript | 📅 2026-09-15 - Open source Looker alternative with deep dbt integration.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,964 | 🐛 21 | 🌐 Go | 📅 2026-09-15 - CLI tool to copy data from any source to any destination with a single command. Load data into your warehouse before dbt transforms it. Supports 50+ sources including Postgres, MongoDB, Salesforce, Shopify.
* [fal](https://github.com/fal-ai/fal) ⭐ 960 | 🐛 78 | 🌐 Python | 📅 2026-09-15 - Add multi-language support (Python) to your dbt project.
* [dbt-agent-skills](https://github.com/dbt-labs/dbt-agent-skills/tree/main) ⭐ 712 | 🐛 31 | 🌐 Python | 📅 2026-09-11 - A curated collection of agent skills, built and maintained by dbt Labs, to help AI coding agents work more effectively with dbt.
* [dbt MCP Server](https://github.com/dbt-labs/dbt-mcp/tree/main) ⭐ 605 | 🐛 45 | 🌐 Python | 📅 2026-09-11 - MCP tools to interact with dbt.
...
* [Elementary](https://github.com/elementary-data/elementary) ⭐ 2,409 | 🐛 13 | 🌐 HTML | 📅 2026-09-15 - A dbt package that provides data anomaly detection as dbt tests.
...
* [DataKitchen Open Source Data Observability](https://github.com/DataKitchen/data-observability-installer) ⭐ 140 | 🐛 6 | 🌐 Python | 📅 2026-09-03 - Data breaks. Servers break. dbt and other tools break. Observability and alerting across and down your data estate. Save time with simple, fast data quality test generation and execution.
* [Misata](https://github.com/rasinmuhammed/misata) ⭐ 68 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Generate known-answer seed and test data for dbt models: declare the expected aggregates (revenue curves, rates, rollups) and assert your models return them exactly.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,873 | 🐛 330 | 🌐 Python | 📅 2026-09-13 - SQL linter that supports dbt and Jinja templating.
* [Altimate Code](https://github.com/AltimateAI/altimate-code) ⭐ 811 | 🐛 295 | 🌐 TypeScript | 📅 2026-09-15 - Open-source data engineering harness with 100+ deterministic tools for building, validating, optimizing, and shipping data products — usable from any LLM, across your warehouses. Ranked #1 on ADE-Bench (78%).
...
* [vscode-dbt-power-user](https://github.com/innoverio/vscode-dbt-power-user) ⭐ 585 | 🐛 158 | 🌐 JavaScript | 📅 2026-09-09 - VSCode extension to give more clarity on model dependencies.
...
* [dbt-bouncer](https://github.com/godatadriven/dbt-bouncer) ⭐ 132 | 🐛 11 | 🌐 Python | 📅 2026-09-15 - Tool to configure and enforce conventions for your dbt project.
...
* [Datanika](https://github.com/datanika-io/datanika-core) ⭐ 0 | 🐛 129 | 🌐 Python | 📅 2026-09-15 - Open-source platform that runs dbt-core transformations alongside dlt-powered extract and load, with 36 connectors, cron scheduling, and run history in one web UI. AGPL-3.0, self-hostable with Docker Compose or Helm.
...
* [dbt-external-tables](https://github.com/dbt-labs/dbt-external-tables) ⭐ 384 | 🐛 63 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Macros to stage your external sources.
...
* [Terraform-dbt Cloud Module](https://github.com/GtheSheep/terraform-provider-dbt-cloud) ⭐ 117 | 🐛 21 | 🌐 Go | 📅 2026-09-15 - IAC in dbt Cloud via Terraform.
...
* [dbt-fabricspark](https://github.com/microsoft/dbt-fabricspark) ⭐ 69 | 🐛 4 | 🌐 Python | 📅 2026-09-15 - A code package from Microsoft for enabling dbt to work with Synapse Spark in Microsoft Fabric.
...
* [Discourse v2](https://github.com/dbt-labs/docs.getdbt.com/discussions) ⭐ 215 | 🐛 231 | 🌐 JavaScript | 📅 2026-09-15 - Revamped and ported hub of main discussions for the community.
...
* [transfermarkt-datasets](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 502 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - E2E dbt project for scraping and transforming football data from Transfermarkt.
